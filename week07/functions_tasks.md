...
При подадено число k и двата низа s и t, проверете дали можете да промените s да бъде същото като t, като извършвате по-малко или точно k операции. Ако можете, принтирайте Yes. Иначе принтирайте No.

Пример

Вход: s = "abc", t = "def", k = 6
...
(Hint: в Python функцията може да изглежда така):
...
[Назад към материалите за функции](../week06/functions.md) · [Продължете с рекурсия](recursion.md)

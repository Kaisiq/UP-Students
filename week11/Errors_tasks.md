...
### Задача 1:
Напишете програма, при която потребителя въвежда 2 числа A и B и като резултат се принтира A/B. Обработете всички възможни грешки. Не използвайте гол `except:` — отпечатайте ясно съобщение за всеки случай.
...
[Назад към материалите за грешки](Еrrors.md) · [Продължете с NumPy](../week12/numpy.md)

...
<br>
Tрябва да подаваме точния брой аргументи на функцията, иначе при извикването ще получим грешка от тип `TypeError`.<br>
...
```
А в този случай при извикването ще получим грешка от тип `TypeError`.

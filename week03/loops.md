...
- стъпката по default е 1, тоест на всяко достигане на проверката в цикъла, стойността на i се увеличава с 1-ца
  - можем да обхождаме и с обратна стъпка, като използваме отрицателно число за целта
...
Вложен цикъл е цикъл в тялото на друг цикъл. 
...
Тук използваме `end=" "`, за да не минаваме на нов ред след `print()`.
...
[Решете задачите за цикли](loops_tasks.md)
